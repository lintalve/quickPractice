...
int main(int argc, char **argv) 
{
   ...
   //glutInitDisplayMode(GLUT_CORE_PROFILE);
   //glutInitDisplayMode(GLUT_COMPATIBILITY_PROFILE);

   glutInitDisplayMode(GLUT_COMPATIBILITY_PROFILE |GLUT_SINGLE | GLUT_RGBA); 
