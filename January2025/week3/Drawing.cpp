//: C16:Drawing.cpp #include <vector>
// Uses Standard vector too!
#include "TPStash2.h"
#include "TStack2.h"
#include "Shape.h"
using namespace std;
...
// A function template:
//Any class that have iterator functionality technically
//But logically this function is made specifically for
//iterators
template<typename I>
void drawAll(I start, I end) {
    while(start != end) {
        (*start)->draw();
        start++;
    }
