...
class Body {
    Door rightFront_d;  // !!!!COMPILER WILL CALL IT in CIL if you don't!!!!
    Door leftFront_d;   // !!!!COMPILER WILL CALL IT in CIL if you don't!!!!
    Door rightRear_d;   // !!!!COMPILER WILL CALL IT in CIL if you don't!!!!
    Door leftRear_d;    // !!!!COMPILER WILL CALL IT in CIL if you don't!!!!
    Door rear_d;        // !!!!COMPILER WILL CALL IT in CIL if you don't!!!!
...
public:
    Body() {
        ...
        rightFront_d = Door();    // !!! YOU'RE INITIALISING !!! AGAIN !!!
        leftFront_d = Door();     // !!! YOU'RE CALLING A SET OF MAIN METHODS HERE
        rightRear_d = Door();     // !!! DEFAULT WINDOW CONSTRUCTOR THAN
        leftRear_d = Door();      // !!! DEFAULT DOOR CONSTRUCTOR THAN
        rear_d = Door();          // !!! DOOR MOVE operator= !!!
        std::cout << "Body after doors constructor" << std::endl;
        Window* front_w = new Window();  // THIS CAN REMAIN HERE, BUIL-IN (just a popinter)
        Window* rear_w = new Window();   // THIS CAN REMAIN HERE, BUIL-IN (just a popinter)
        std::cout << "Body after windows constructor" << std::endl;
        Wheel* rightFront_w = new Wheel();  // THIS CAN REMAIN HERE, BUIL-IN (just a popinter)
        Wheel* leftFront_w = new Wheel();   // THIS CAN REMAIN HERE, BUIL-IN (just a popinter)
        Wheel* rightRear_w = new Wheel();   // THIS CAN REMAIN HERE, BUIL-IN (just a popinter)
        Wheel* leftRear_w = new Wheel();    // THIS CAN REMAIN HERE, BUIL-IN (just a popinter)
