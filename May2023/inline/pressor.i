...
# 182 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/unistd.h" 3 4
...
# 203 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/unistd.h" 3 4
...
# 204 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/unistd.h" 2 3 4
...
# 4 "preprocessor8.cpp" 2
# 1 "./assert.h" 1
# 5 "preprocessor8.cpp" 2
# 43 "preprocessor8.cpp"
int main(void){

    do{ int product = (3) * (6); for(int i=0; i<product; i++){ printf("%d\n", i); } }while(0);



    do{ const char* string0 = "we can assing things"; puts(string0); while(*string0 != '\0'){ printf("%c ", *string0); string0++; } }while(0);
    int x = 30;
    do{ if(!(x<20)){ fprintf(__stderrp, "preprocessor8.cpp"":%d: %s %s\n", 51, "x<20", "assertion failed"); exit(1); } }while(0);
    return 0;
}
