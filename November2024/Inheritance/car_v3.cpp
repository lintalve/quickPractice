...
class Body {
    ...
    //IF YOU DON'T CALL THEM EXXPLICITLY IN THE !!!CONSTRUCTOR INITIALISER LIST!!! HALLO!!!
    Door rightFront_d;
    Door leftFront_d;
    Door rightRear_d;
    Door leftRear_d;
...
int main(int argc, const char* argv[]) {
    ...
    myDoor = Door(); //due to embedded Window member user-defined object, it's constructor is AUTOMATICALLY if not
