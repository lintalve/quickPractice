...
public:
    ...
    |                                                                           |
    |                                                                           |
    | `static const int` initialized inside class (integral)                    | Usually **no storage**; replaced by literal
    |                                                                           | constants in code (if address not taken).
    ...
    */
    ...
    static const int int3 = 30;  //compiler add those to its symbol table while working
...
int main(int argc, const char* argv[]) {
    ...
    std::print("{} {} {}\n", anInt1, anInt2, anInt3); //compiler just inserts 10, 20, 30 while compiling from its table
                                                      //as an imediate
